...
public class AutoComboBox extends PlainDocument {
    ...
    public AutoComboBox(JComboBox comboBox) {
        ...
        editor.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if (hidePopupOnFocusLoss) AutoComboBox.this.comboBox.setPopupVisible(false);
            }
        });
        ...
        editor.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(java.awt.event.KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    ...
                    AutoComboBox.this.comboBox.setSelectedIndex(0);
                    AutoComboBox.this.editor.setText(AutoComboBox.this.comboBox.getSelectedItem().toString());
                    highlightCompletedText(0);
                }
            }
        });
