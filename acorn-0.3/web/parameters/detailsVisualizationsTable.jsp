...
<div class="tableBox">
    ...
    <h:form id="visualizations">
        ...
        <h:column>
            <f:facet name="header">
                <h:outputText value="Select visualizations" />
            </f:facet>
        ...
        <h:column>
            <f:facet name="header">
                <h:outputText value="Visualizations name" />
            </f:facet>
            <h:outputText escape="false" value="
                          <div title=\"header=[Sbml Id] body=[#{visualizations.sid}]\">
                          #{visualizations.name}
                          </div>"
                          />
        </h:column>
